    ...
    <Html lang="en">
      <Head>
        ...
        <meta name="description" content="Fully-managed enterprise edge cloud services - compute, networking, storage and more - designed for managed service providers and the modern enterprise." key="desc" />
            ...
            <link rel="icon" type="image/png" sizes="32x32" href="/unitellasicon.png" />
            <link rel="icon" type="image/png" sizes="16x16" href="/unitellasicon.png" />
            <link rel='icon' sizes='192x192' type='image/png' href='/unitellasicon.png' />
            <link rel='icon' sizes='512x512' type='image/png' href='/unitellasicon.png' />
            <meta name="apple-mobile-web-app-title" content="Unitellas - THE FIRST HYPER SCALE EDGE CLOUD IN AFRICA" />
            <link rel='apple-touch-icon' type='image/png' href='/unitellasicon.png' />
            <meta name='msapplication-square310x310logo' content='/unitellasicon.png' />
